    ...
    <div className="space-y-6">
      ...
      <FormCard action={addTournamentTeamAction} className="space-y-4">
        ...
        <div className="flex flex-col gap-1">
          <p className="text-sm font-black uppercase text-court-mint">Pridať družstvo</p>
          <p className="text-sm text-court-blue">Zadaj názov turnajového družstva. Klubové tímy Tatry/Ostatní sa tu nepoužívajú.</p>
        </div>
        <label className="grid gap-2">
          <span className="text-sm font-bold text-court-ink">Názov družstva</span>
          <input name="display_name" required className="focus-ring min-h-11 rounded-[8px] border border-court-line px-4 py-3 text-base" />
        </label>
        ...
        <SubmitButton
          ...
          idleLabel="Pridať družstvo do turnaja"
          pendingLabel="Pridávam družstvo..."
        />
      </FormCard>
            ...
            <Card key={team.id} className="grid gap-3 border-dashed">
              <div className="flex items-center justify-between gap-3">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="break-words text-xs text-court-blue">Skupina {team.groupCode}</p>
                </div>
